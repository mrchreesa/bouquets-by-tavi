...
- **Never hand-edit `images/hero-bouquet.svg`, `images/story.svg`, or `images/hero-decor.svg`.** All three are generated by scripts in `tools/` (`gen_hero_bouquet.py`, `gen_story_bouquet.py`, `gen_hero_decor.py`). To change any of them, edit the script and regenerate, e.g. `python3 tools/gen_story_bouquet.py images/story.svg`.
